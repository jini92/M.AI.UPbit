...
> **문서 번호**: T-001
> **작성일**: 2026-02-25
> **최종 업데이트**: 2026-02-25 (Phase 8 Ollama 통합)
...
| `test_analysis.py` | 37 | technical.py, llm.py (OpenAI/Ollama) |
...
| 우선순위 | 대상 | 현재 | 목표 | 방법 |
|---|---|---|---|---|
| 🟡 중간 | `cli.py` | 45% | 70%+ | quant/train 서브커맨드 테스트 추가 |
